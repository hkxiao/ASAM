...
--valid-datasets dataset_hrsod_val dataset_big_val dataset_ade20k_val dataset_voc2012_val dataset_cityscapes_val dataset_coco2017_val dataset_LVIS dataset_egohos dataset_BBC038v1\
