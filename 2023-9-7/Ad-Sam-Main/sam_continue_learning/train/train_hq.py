...
if __name__ == "__main__":
    ...
    dataset_coco_subset_val = {"name": "COCO",
                "im_dir": "/data/tanglv/xhk/data/COCO/img",
                "gt_dir": "/data/tanglv/xhk/data/COCO/gt",
                "im_ext": ".png",
                "gt_ext": ".png"}
    
    dataset_big_val = {"name": "BIG",
                "im_dir": "/data/tanglv/xhk/data/BIG/test",
                "gt_dir": "/data/tanglv/xhk/data/BIG/test",
                "im_ext": "_im.jpg",
                "gt_ext": "_gt.png"}
    
    dataset_hrsod_val = {"name": "HRSOD-TE",
                "im_dir": "/data/tanglv/xhk/data/sod_data/HRSOD-TE/imgs",
                "gt_dir": "/data/tanglv/xhk/data/sod_data/HRSOD-TE/gts",
                "im_ext": ".jpg",
                "gt_ext": ".png"}
    
    dataset_ade20k_val = {"name": "ADE20K_2016_07_26",
                "im_dir": "/data/tanglv/xhk/data/ADE20K_2016_07_26/images/validation",
                "gt_dir": "/data/tanglv/xhk/data/ADE20K_2016_07_26/images/validation",
                "im_ext": ".jpg",
                "gt_ext": "_seg.png"}
