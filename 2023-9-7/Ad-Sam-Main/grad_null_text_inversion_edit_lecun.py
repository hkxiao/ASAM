...
if __name__ == '__main__':
    ...
    for file in os.listdir(args.data_root):    
        ...
        if 'png' not in file or 'control' in file: continue 
        name=file[:-4] 
        img_path = args.data_root+'/'+file
        control_mask_path = args.control_mask_dir+'/'+name+'_control.png'
        ...
        # show 
        ptp_utils.view_images([image_inv[0]], prefix=os.path.join(save_path,'adv',name),shuffix='.jpg')
