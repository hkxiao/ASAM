...
python -m torch.distributed.run --nproc_per_node=4 --master_port=30002  main.py \
    ...
    --train-datasets dataset_sa000000_direct_inversion_adv_augmentation_img_adv_prompt_sam2 dataset_sa000000_feat_control dataset_dis dataset_thin dataset_fss dataset_duts dataset_duts_te dataset_ecssd dataset_msra \
