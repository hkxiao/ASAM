...
python -m torch.distributed.run --nproc_per_node=1 --master_port=30001  SDXL.py \
    --model-type vit_t \
    ...
    --train-datasets dataset_dis dataset_thin dataset_fss dataset_duts dataset_duts_te dataset_ecssd dataset_msra \
