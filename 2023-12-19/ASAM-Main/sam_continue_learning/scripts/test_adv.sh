...
python -m torch.distributed.launch --nproc_per_node=8 --master_port=30003  main.py \
--model-type vit_b \
...
--valid-datasets dataset_big_val dataset_ade20k_val dataset_voc2012_val dataset_cityscapes_val dataset_coco2017_val dataset_LVIS dataset_egohos dataset_BBC038v1\

#dataset_camo dataset_big_val dataset_BBC038v1 dataset_DOORS1 dataset_DOORS2 dataset_ZeroWaste dataset_ndis_train dataset_Plittersdorf_test dataset_egohos dataset_LVIS \
# --visualize \
#--baseline
