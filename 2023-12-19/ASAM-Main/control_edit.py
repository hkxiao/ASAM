...
parser.add_argument('--save_root', default='output/sa_000000-Control', type=str, help='random seed')   
...
parser.add_argument('--controlnet_path', default='ControlNet-main/train_output_sdxl/checkpoint-15000/controlnet', type=str, help='random seed')    
