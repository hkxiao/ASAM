...
start_program() {
    ...
    python $2 \
    --save_root=output/sa_000000-Control-Canny \
    ...
    --controlnet_path=ControlNet-main/train_output_ssd_canny/checkpoint-30000/controlnet \
    --SD_path=ckpt/SSD-1B \
    --ddim_steps=50 \
    --control_scale=1.0 \
    --start=$3 \
...
start=(1 4500 5000 5500 6000 6500 7000 7500)
end=(1 5000 5500 6000 6500 7000 7500 8000)
...
do
    ...
    start_program ${CUDA_VISIBLE_DEVICES_LIST[i]} control_B_edit.py ${start[i]} ${end[i]} &
    PID_LIST+=($!)
    STATUS+=(-1)
done
